                ...
                <div>
                    ...
                    <div>
                        <ul class="nav__list">
                            ...
                            <a href="{{ url('/product/create') }}" class="nav__link active">
                                <i class='bx bx-book-content nav__icon'></i>
                                <span class="nav__text">Create Product</span>
                            </a>
                            <a href="{{ url('/product/view-data') }}" class="nav__link active">
                              <i class='bx bx-book-content nav__icon'></i>
                              <span class="nav__text">Data Product</span>
                          </a>
                        </ul>
                    </div>
                    <a href="#" class="nav__link active">
